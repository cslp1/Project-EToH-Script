...
return {
    ...
    Towers = {
        ...
        { name = "ToB",  category = "Ring0", suggestedTime = { min = "3", sec = "0" } },
        { name = "ToCD",  category = "Ring0", suggestedTime = { min = "3", sec = "5" } },
        { name = "ToBM",  category = "Ring0", suggestedTime = { min = "3", sec = "0" } },
        ...
        { name = "ToFH",  category = "SteelspireHorizon", suggestedTime = { min = "3", sec = "0" } },
        { name = "ToCBTS",  category = "SteelspireHorizon", suggestedTime = { min = "3", sec = "0" } },
        { name = "ToTFC",  category = "SteelspireHorizon", suggestedTime = { min = "3", sec = "0" } },
        --Zone 1
        ...
        --Zone 4       
        { name = "ToAC",  category = "Zone4", suggestedTime = { min = "3", sec = "0" } },
        ...
        --Zone 8
        { name = "CoPE",  category = "Zone8", suggestedTime = { min = "3", sec = "0" } },
