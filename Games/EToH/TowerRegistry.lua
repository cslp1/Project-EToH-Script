...
return {
    ...
    Towers = {
        ...
        { name = "SoTP",  category = "ForgottenRidge", suggestedTime = { min = "6", sec = "5" } },
        ...
        { name = "ToTST",  category = "LostRiver", suggestedTime = { min = "6", sec = "0" } },
        { name = "ToLOZ",  category = "LostRiver", suggestedTime = { min = "14", sec = "0" } },
        { name = "ToDL",  category = "LostRiver", suggestedTime = { min = "6", sec = "0" } },
        { name = "ToOO",  category = "LostRiver", suggestedTime = { min = "14", sec = "0" } },
        { name = "ToCS",  category = "LostRiver", suggestedTime = { min = "14", sec = "0" } },
        { name = "ToWaW",  category = "LostRiver", suggestedTime = { min = "6", sec = "0" } },
        { name = "ToTJ",  category = "LostRiver", suggestedTime = { min = "14", sec = "0" } },
        { name = "ToTEM",  category = "LostRiver", suggestedTime = { min = "14", sec = "0" } },
        --Ring 6
        ...
        --The Doghouse
        { name = "MCoMC",  category = "TheDoghouse", suggestedTime = { min = "4", sec = "36" } },
        --Legacy Fortress
    ...
    TowerRush = {
        ...
        { name = "LRTR", category = "LostRiver", suggestedTime = { min = "33", sec = "0" }, isTowerRush = true, },
        ...
        { name = "AATR", category = "ArcaneArea", suggestedTime = { min = "40", sec = "0" }, isTowerRush = true, },
        { name = "Z4TR", category = "Zone4", suggestedTime = { min = "40", sec = "0" }, isTowerRush = true, },
        { name = "Z7TR", category = "Zone7", suggestedTime = { min = "40", sec = "0" }, isTowerRush = true, },
